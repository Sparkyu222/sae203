                            ...
                            <div class="w-[70%] flex flex-col gap-[30px] p-[20px] border rounded-[20px]">
                                <div class="flex flex-col gap-[10px]">
                                    ...
                                    <div class="grid grid-cols-3 gap-[20px]">
                                        <div class="flex flex-col gap-[10px]">
                                            <label for="" class="ml-[15px]">Code postal</label>
                                            <input type="text" name="" id="formOnglet4" class="w-full px-[20px] py-[10px] block bg-gray-200 rounded-[20px] border-0">
                                        </div>
                                        <div class="flex flex-col gap-[10px] col-span-2">
                                            <label for="" class="ml-[15px]">Complément d'adresse</label>
                                            <input type="text" name="" id="formOnglet5" class="w-full px-[20px] py-[10px] block bg-gray-200 rounded-[20px] border-0">
                                        </div>
                                    </div>
                                    <div class="grid grid-cols-2 gap-[20px]">
                                        <div class="flex flex-col gap-[10px]">
                                            <label for="" class="ml-[15px]">Ville</label>
                                            <input type="text" name="" id="formOnglet6" class="w-full px-[20px] py-[10px] block bg-gray-200 rounded-[20px] border-0">
                                        </div>
                                        <div class="flex flex-col gap-[10px]">
                                            <label for="" class="ml-[15px]">Pays</label>
                                            <input type="text" name="" id="formOnglet7" class="w-full px-[20px] py-[10px] block bg-gray-200 rounded-[20px] border-0">
                                        </div>
                                    </div>
                                </div>
                                <div class="flex justify-end gap-[20px]">
